...
/* This CSS is for the st.image component when it's rendered */
/* The image itself will have an external div that needs to be centered */
.stImage > img {
...
# ----------------------------
    ...
    with tab1:
        ...
        if input_method == "📁 Upload Image":
            input_file = st.file_uploader("Choose an image...", type
